...
export const LinkedinIcon = React.forwardRef<SVGSVGElement, LanternIconProps>(
  ({ size = 16, ...props }, ref) => (
    <svg
      ref={ref}
      width={size}
